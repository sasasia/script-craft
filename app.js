...
// ۲. بانک اطلاعاتی سوالات آزمون (فصل اول و دوم)
const quizzes = [
    // سوالات فصل اول
    {
    ...
    // سوالات جدید فصل دوم (شخصیت‌پردازی) - از اینجا اضافه کنید:
    {
        question: "تفاوت 'خواست ظاهری' (Want) و 'نیاز درونی' (Need) در شخصیت‌پردازی چیست؟",
        options: ["هیچ تفاوتی ندارند", "خواست مربوط به هدف بیرونی و نیاز مربوط به تحول روحی شخصیت است", "نیاز همیشه زودتر از خواست برآورده می‌شود", "خواست را فقط ضدقهرمان دارد"],
        correct: 1
    },
    {
        question: "چرا وجود 'نقص شخصیت' (Character Flaw) برای قهرمان داستان ضروری است؟",
        options: ["تا داستان زودتر تمام شود", "تا ضدقهرمان بتواند او را شکست دهد", "برای ایجاد همذات‌پنداری در مخاطب و نشان دادن روند تغییر شخصیت", "تا دیالوگ‌های کمتری بگوید"],
        correct: 2
    },
    {
        question: "وظیفه اصلی یک ضدقهرمان (Antagonist) استاندارد در درام چیست؟",
        options: ["کارهای بد بی‌دلیل انجام دادن", "هدف گرفتن عمیق‌ترین نقطه‌ضعف قهرمان و به چالش کشیدن او", "دوست شدن با قهرمان در انتهای داستان", "تعویض لوکیشن‌های فیلم"],
        correct: 1
    }
];
